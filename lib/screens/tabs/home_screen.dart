...
// ========================================================================= //
// BAGIAN UTAMA HOMESCREEN (STATE MANAGEMENT DAN LAYOUT)
// ========================================================================= //
...
class _HomeScreenState extends State<HomeScreen> {
  ...
  // State untuk mengelola daftar artikel dan infinite scroll
  ...
  // State untuk mengelola bookmark
      ...
      setState(() {
        ...
        if (response.error.isNotEmpty && response.error != "loading") {
          ...
          if (response.articles.isEmpty) {
            ...
            // Mencegah duplikasi data saat hot reload di mode debug
  ...
  /// Fungsi untuk "Tarik untuk Memuat Ulang"
  Future<void> _onRefresh() async {
    setState(() {
      ...
      _currentError = '';
      _isLoadingMore = false; // Reset status loading
    });
    // Memuat kembali halaman pertama
    getAllNewsBloc.getAllNews(page: 1);
  }
  ...
  Widget _buildAllNewsSection() {
    // Menampilkan Shimmer saat loading awal
      ...
      children: [
        ListView.builder(
          ...
          itemBuilder: (context, index) {
            ...
            // Menggunakan widget ArticleCard yang diimpor
            return ArticleCard(
              article: article,
  ...
  /// Widget untuk menampilkan daftar placeholder (shimmer effect).
  Widget _buildShimmerList() {
    return ListView.builder(
      itemCount: 5, // Tampilkan 5 placeholder
      shrinkWrap: true,
      physics: const NeverScrollableScrollPhysics(),
...
/// Widget private untuk satu kartu placeholder (shimmer).
