...
class _ManageNewsScreenState extends State<ManageNewsScreen> {
  // Instance repository untuk operasi hapus
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        title: const Text("Kelola Artikel Saya", style: TextStyle(color: Colors.white)),
        backgroundColor: const Color(0xFF1A1A2E),
        iconTheme: const IconThemeData(color: Colors.white),
      ),
      body: SafeArea(
        child: RefreshIndicator(
          onRefresh: () => getAuthorNewsBloc.getAuthorNews(),
          color: Colors.white,
          ...
          child: StreamBuilder<ArticleResponse>(
            ...
            builder: (context, snapshot) {
              ...
              if (articles.isEmpty) {
                return const Center(child: Text("Anda belum memiliki artikel.", style: TextStyle(color: Colors.white70, fontSize: 16)));
              }
