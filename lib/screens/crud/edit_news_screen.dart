...
class _EditNewsScreenState extends State<EditNewsScreen> {
      ...
      child: Form(
        ...
        child: Column(
          ...
          children: [
            ...
            _buildTextField(_summaryController, "Ringkasan Singkat", icon: Icons.short_text, maxLines: 3),
            ...
            _buildSectionHeader("Media & Konten"),
  ...
  Widget _buildSectionHeader(String title) {
    return Padding(
      ...
      child: Text(title, style: const TextStyle(color: Colors.blueAccent, fontSize: 18, fontWeight: FontWeight.bold)),
    );
  }

  Widget _buildTextField(TextEditingController controller, String hintText, {int maxLines = 1, IconData? icon}) {
    return Padding(
      ...
      child: TextFormField(
        ...
        validator: (value) => value!.isEmpty ? '$hintText tidak boleh kosong' : null,
      ),
    );
  }
  ...
  Widget _buildSwitchTile() {
    return Container(
      ...
      decoration: BoxDecoration(color: Colors.white.withOpacity(0.05), borderRadius: BorderRadius.circular(12.0)),
      child: SwitchListTile(
        title: const Text("Langsung Publikasikan?", style: TextStyle(color: Colors.white)),
        value: _isPublished,
